...
in the cypress config will be forwarded to your server. The cypress-runner will
trigger a request for an index.html. Your server needs to access and send the custom
index file after enriching it with a script to load the actual test.
